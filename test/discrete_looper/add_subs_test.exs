defmodule ViaUtils.DiscreteLooper.AddSubsTest do
  use ExUnit.Case
  require Logger
  alias ViaUtils.Helper.DiscreteLooper.GenServer, as: DLG
  alias ViaUtils.DiscreteLooper
  ...
  test "add subs test", context do
    ...
    key = :test
    interval = 50
    looper = ViaUtils.DiscreteLooper.new_discrete_looper("looper", interval)
